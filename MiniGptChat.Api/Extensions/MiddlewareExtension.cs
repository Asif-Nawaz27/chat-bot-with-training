...
namespace MiniGptChat.Api.Extensions
{
    public static class MiddlewareExtension
    {
        ...
        {
            // Registers the MiniGptChat library's tokenizer/model/training/generation/chat
            // services (see MiniGptChat/ServiceRegistration.cs) - the exact same set the
            // console app (MiniGptChat.Cli) uses, so both entry points behave identically.
            services.AddMiniGptChatServices();
        ...
        {
            // Allows the MiniGptChat.Web React app(served from Vite's dev server on a
